...
export const menuItems = [
    new Menu (10, 'ADMIN_NAV.DASHBOARD', 'dashboard', null, 'dashboard', null, false, 0, 10),
    ...
    new Menu (190, 'ADMIN_NAV.Documents', null, null, 'business', null, true, 0, 0),
    new Menu (191, 'ADMIN_NAV.ReceivableDoc', '/payments/receivable-list', null, 'assignment_turned_in', null, false, 190, 0),
    new Menu (192, 'ADMIN_NAV.PayableDoc', '/payments/payable-list', null, 'note', null, false, 190, 0),
    new Menu (200, 'ADMIN_NAV.EMPLOYEES', null, null, 'group_add', null, true, 0, 0),
    new Menu (201, 'ADMIN_NAV.EMPLOYEES', '/hr', null, 'assignment_ind', null, false, 200, 0), 
    ...
    // new Menu (300, 'ADMIN_NAV.EXTERNAL_LINK', null, 'http://themeseason.com', 'open_in_new', '_blank', false, 0,9)
]
