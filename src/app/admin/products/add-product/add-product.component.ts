...
export class AddProductComponent implements OnInit {
  ...
  public getProductById(){
    this.appService.getProductById(this.id).subscribe((data:any)=>{
      ...
      console.log("======getProductById===data.color:: " + data.color);
      console.log("======getProductById===data.color[0]:: " + data.color[0]);
      console.log("======getProductById===data.color[1]:: " + data.color[1]);
